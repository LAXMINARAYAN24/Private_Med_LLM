...
import wandb
import os
from args_finetune import load_process_data, generate_prompt, load_model, train, test, train_test_direct
...
def main():
    ...
    parser.add_argument('--model', type=str, default="opt", required=True,
                        help = "choose llm models: llama2, llama3, opt (default: opt)")
    
    parser.add_argument('--max_seq', type=int, default = 2048, required=True,
    ...
    parser.add_argument('--max_steps', type=int, default=200, required=True,
    ...
    parser.add_argument('--sample', type=str, default="a",
                        help = "[a | b | c]")
    ...
    # python main.py --mode test --output_path outputs_0424 --run_name test_opt --model opt --max_seq 500 --batch_size 4 --max_steps 200
